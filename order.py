...
##create new order##
  ...
  def order_create():
    ...
    ord_template["values"] = ["Professional 1 (logo on left side)","Professional 2 (logo on right side)","Simplified 1(logo on left side)","Simplified 1(logo on right side)","Business Classic(UTF-8)"]
    ...
    # try:
      ...
      def order_edit_previewline():
        ...
        #----------------Professional 2 (logo on right side)------------------
          ...
          canvas.create_window(750, 380,window=ord_canvas_ship)
          canvas.create_text(656, 380, text="John Doe", fill="black", font=('Helvetica 10 '))
          canvas.create_text(698, 395, text="381 South Bedford Road", fill="black", font=('Helvetica 10'))
      ...
      orde_templ["values"] = ["Professional 1 (logo on left side)","Professional 2 (logo on right side)","Simplified 1(logo on left side)","Simplified 1(logo on right side)","Business Classic(UTF-8)"]
