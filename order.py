...
##create new order##
  ...
  def order_create():
    ...
    def order_newline():
      ...
      #add new product
        ...
        def order_edit_product():  
            try:
              itemid = ord_create_protree.item(ord_create_protree.focus())["values"][0]
        ...
        def ord_pro_items_selected(event):
        ...
        listbox = Listbox(newselection,height = 8,  
                        width = 29,  
                        bg = "white",
                        activestyle = 'dotbox',  
                        fg = "black",
        ...
        listbox.place(x=660,y=75,height=530,width=240)
        listbox.bind('<<ListboxSelect>>', ord_pro_items_selected)
    ...
    def order_create_previewline():
      ...
      if ord_template.get() == 'Professional 1 (logo on left side)':
        ...
        titletext_canvas.config(text=ord_titletext.get(),anchor="w")
        ...
        canvas.create_text(450, 250, text=""+ord_orderid.get(), fill="black", font=('Helvetica 11'))
        canvas.create_text(450, 270, text=ord_date.get_date(), fill="black", font=('Helvetica 11'))
        canvas.create_text(450, 290, text=ord_date.get_date(), fill="black", font=('Helvetica 11'))
        canvas.create_text(440, 310, text=""+ord_terms.get(), fill="black", font=('Helvetica 11'))  
        ...
        ord_canvas_name.config(text=ord_to.get(),anchor="w",bg="white")
        ...
        addr_can_lab.insert("1.0",ord_addr.get("1.0",END))
        ...
        ord_canvas_ship.config(text=ord_ship.get(),anchor="w",bg="white")
        ...
        bg="white",cursor="arrow",bd=0)
        shipaddr_can_lab.insert("1.0",ord_shipaddr.get("1.0",END))
        ...
        pageheadertext_canvas.config(text=ord_pageheadertext.get(),anchor="w")
        ...
        for child in ord_pro_create_tree.get_children():
          previewdata = list(ord_pro_create_tree.item(child, 'values'))
          if not taxcheck:
        ...
        if not taxcheck:
          ...
          canvas.create_text(780, 730, text="Discount", fill="black", font=('Helvetica 10'))
          canvas_disc = Label(canvas, font=('Helvetica 10 '),width=13)
          canvas_disc.config(text=discount1.cget("text"),anchor="e",bg="white")
          ...
          if symbolcheck[0] == "before amount":
            ...
            canvas.create_text(780, 730, text=discount.cget('text'), fill="black", font=('Helvetica 10'))
            canvas_disc = Label(canvas, font=('Helvetica 10 '),width=13)
            canvas_disc.config(text=symbolcheck[1]+str(discount1.cget("text")),anchor="e",bg="white")
            canvas.create_window(920, 728,window=canvas_disc)

            canvas.create_text(780, 755, text="Subtotal", fill="black", font=('Helvetica 10'))
            canvas_sub = Label(canvas, font=('Helvetica 10 '),width=13)
            canvas_sub.config(text=symbolcheck[1]+str(sub1.cget("text")),anchor="e",bg="white")
            canvas.create_window(920, 753,window=canvas_sub)
           
            
            canvas_extra = Label(canvas, font=('Helvetica 10 '),width=13)
            canvas_extra.config(text=symbolcheck[1]+str(ord_extracost.get()),anchor="e",bg="white")
            canvas.create_window(920, 778,window=canvas_extra)
            ...
            canvas_total = Label(canvas, font=('Helvetica 10 bold'),width=13)
            canvas_total.config(text=symbolcheck[1]+str(order1.cget("text")),anchor="e",bg="white")
            canvas.create_window(920, 803,window=canvas_total)
            canvas.create_text(780, 805, text="Total Order", fill="black", font=('Helvetica 10 bold'))
            ...
            canvas.create_text(780, 730, text=discount.cget('text'), fill="black", font=('Helvetica 10'))
            canvas_disc = Label(canvas, font=('Helvetica 10 '),width=13)
            canvas_disc.config(text=str(discount1.cget("text"))+symbolcheck[1],anchor="e",bg="white")
            canvas.create_window(920, 728,window=canvas_disc)

            canvas.create_text(780, 755, text="Subtotal", fill="black", font=('Helvetica 10'))
            canvas_sub = Label(canvas, font=('Helvetica 10 '),width=13)
            canvas_sub.config(text=str(sub1.cget("text"))+symbolcheck[1],anchor="e",bg="white")
            canvas.create_window(920, 753,window=canvas_sub)
           
            
            canvas_extra = Label(canvas, font=('Helvetica 10 '),width=13)
            canvas_extra.config(text=str(ord_extracost.get())+symbolcheck[1],anchor="e",bg="white")
            canvas.create_window(920, 778,window=canvas_extra)
            ...
            canvas_total = Label(canvas, font=('Helvetica 10 bold'),width=13)
            canvas_total.config(text=str(order1.cget("text"))+symbolcheck[1],anchor="e",bg="white")
            canvas.create_window(920, 803,window=canvas_total)
            canvas.create_text(780, 805, text="Total Order", fill="black", font=('Helvetica 10 bold'))
          ...
          if symbolcheck[0] == "before amount":
            ...
            canvas_tax1.config(text=symbolcheck[1]+str(tax1sum.cget("text")),anchor="e",bg="white")
            canvas.create_window(920, 778,window=canvas_tax1)
            
            
            canvas_extacost = Label(canvas, font=('Helvetica 10 '),width=13)
            canvas_extacost.config(text=symbolcheck[1]+str(ord_extracost.get()),anchor="e",bg="white")
            ...
            canvas.create_text(780, 780, text="TAX1", fill="black", font=('Helvetica 10'))
            canvas_tax1 = Label(canvas, font=('Helvetica 10 '),width=13)
            canvas_tax1.config(text=str(tax1sum.cget("text"))+symbolcheck[1],anchor="e",bg="white")
            canvas.create_window(920, 778,window=canvas_tax1)
            
            
            canvas_extacost = Label(canvas, font=('Helvetica 10 '),width=13)
            canvas_extacost.config(text=str(ord_extracost.get())+symbolcheck[1],anchor="e",bg="white")
            canvas.create_window(920, 803,window=canvas_extacost)
          ...
          if symbolcheck[0] == "before amount":
            ...
            canvas_tax2.config(text=symbolcheck[1]+str(tax2sum.cget("text")),anchor="e",bg="white")
            ...
            canvas.create_text(780, 805, text="TAX2", fill="black", font=('Helvetica 10'))
            canvas_tax2 = Label(canvas, font=('Helvetica 10 '),width=13)
            canvas_tax2.config(text=str(tax2sum.cget("text"))+symbolcheck[1],anchor="e",bg="white")
            canvas.create_window(920, 803,window=canvas_tax2)
        ...
        bg="white",cursor="arrow",bd=0)
        comments.insert("1.0",ord_commnotes.get("1.0",END))
        ...
        bg="white",cursor="arrow",bd=0)
        pre_terms.insert("1.0",ord_termsnotes.get("1.0",END))
      ...
      #----------------Professional 2 (logo on right side)------------------
        ...
        canvas.create_text(920, 250, text=ord_orderid.get(), fill="black", font=('Helvetica 11'))
        canvas.create_text(920, 270, text=ord_date.get_date(), fill="black", font=('Helvetica 11'))
        canvas.create_text(920, 290, text=ord_duedate.get_date(), fill="black", font=('Helvetica 11'))
        canvas.create_text(920, 310, text=ord_terms.get(), fill="black", font=('Helvetica 11'))  
        ...
        ord_canvas_name.config(text=ord_to.get(),anchor="w")
        ...
        ord_canvas_ship.config(text=ord_ship.get(),anchor="w")
        ...
        bg="white",cursor="arrow",bd=0)
        addrship_can_lab.insert("1.0",ord_shipaddr.get("1.0",END))
        addr_can_lab.config(state=DISABLED) 
        ...
        if not taxcheck:
          ...
          canvas.create_text(780, 730, text=discount.cget('text'), fill="black", font=('Helvetica 10'))
          canvas_disc = Label(canvas, font=('Helvetica 10 '),width=13)
          canvas_disc.config(text=str(discount1.cget("text")),anchor="e",bg="white")
          canvas.create_window(920, 728,window=canvas_disc)
        ...
        for child in ord_pro_create_tree.get_children():
          previewdata = list(ord_pro_create_tree.item(child, 'values'))
          if not taxcheck:
            ord_previewtree.insert(parent='', index='end',text='', values=(previewdata[1],previewdata[4],previewdata[6]))
          elif taxcheck[12] == "1":
            ord_previewtree.insert(parent='', index='end',text='', values=(previewdata[1],previewdata[4],previewdata[6]))
          elif taxcheck[12] == "2":
            ord_previewtree.insert(parent='', index='end',text='', values=(previewdata[1],previewdata[4],previewdata[7]))
          elif taxcheck[12] == "3":
            ord_previewtree.insert(parent='', index='end',text='', values=(previewdata[1],previewdata[4],previewdata[8]))
      ...
      #----------------Business Classic------------------ 
        ...
        canvas_ordid.config(text=ord_orderid.get(),anchor="w")
        canvas.create_window(962, 330,window=canvas_ordid)
        # canvas.create_text(930, 240, text="ORD1/2022", fill="black", font=('Helvetica 11'))
        canvas.create_text(930, 360, text=ord_date.get(), fill="black", font=('Helvetica 11'))
        canvas.create_text(930, 390, text=ord_duedate.get(), fill="black", font=('Helvetica 11'))
        ...
        for child in ord_pro_create_tree.get_children():
          previewdata = list(ord_pro_create_tree.item(child, 'values'))
          if not taxcheck:
            ord_previewtree.insert(parent='', index='end',text='', values=(previewdata[1],previewdata[2],previewdata[4],previewdata[3],previewdata[6]))
          elif taxcheck[12] == "1":
            ord_previewtree.insert(parent='', index='end',text='', values=(previewdata[1],previewdata[2],previewdata[4],previewdata[3],previewdata[6]))
          elif taxcheck[12] == "2":
            ord_previewtree.insert(parent='', index='end',text='', values=(previewdata[1],previewdata[2],previewdata[4],previewdata[3],previewdata[7]))
          elif taxcheck[12] == "3":
            ord_previewtree.insert(parent='', index='end',text='', values=(previewdata[1],previewdata[2],previewdata[4],previewdata[3],previewdata[8]))
    ...
    ord_template["values"] = ["Professional 1 (logo on left side)","Professional 2 (logo on right side)","Simplified 1 (logo on left side)","Simplified 2 (logo on right side)","Business Classic"]
  ...
  def order_edit():
    # try:
      ...
      pop.title("Orders")
      pop.geometry("950x690+150+0")
      ord_editid = ordtree.item(ordtree.focus())["values"][1]
      ...
      def order_newline():
        ...
        if cuse == "":
          ...
          def order_edit_product():  
            try:
              itemid = ord_edit_protree.item(ord_edit_protree.focus())["values"][0]
      ...
      def order_edit_printsele():
        ...
        if orde_templ.get() == 'Professional 1 (logo on left side)':
          ...
          pdf.drawCentredString(302,770,orde_titletext.get())
          pdf.drawCentredString(302,475,orde_pageheadertext.get())
          pdf.drawImage("images/"+company_data[13],30,665,width=200,height=90)

          pdf.drawString(30,635,"Order#")
          pdf.drawString(30,620,"Order date")
          pdf.drawString(30,605,"Due date")
          pdf.drawString(30,590,"Terms")
          pdf.drawString(30,575,"Order ref#")

          pdf.drawString(140,635,orde_orderid.get())
          pdf.drawString(140,620,str(orde_date.get_date()))
          pdf.drawString(140,605,str(orde_duedate.get_date()))
          pdf.drawString(140,590,orde_terms.get())
          pdf.drawString(140,575,"")

          pdf.drawString(60,550,"Order to")
          pdf.line(60,548,112,548)
          pdf.drawString(60,535,orde_name.get())
          invto_addr = orde_addr.get("1.0","end-1c")
          ...
          pdf.drawString(300,535,orde_ship.get())
          shipto_addr = orde_shipaddr.get("1.0","end-1c")
          ...
          pdf.drawRightString(580,745, company_data[1])
          pdf.setFont('Helvetica',12)
          text=company_data[2]
          wraped_text="\n".join(wrap(text,30))
          ...
          v1 = 450
          v2 = 430
          for i in edit_pro_tree.get_children():
      ...
      def order_edit_previewline():
        ...
        if orde_templ.get() == 'Professional 1 (logo on left side)':
          ...
          titletext_canvas = Label(canvas, font=('Helvetica 10 '),width=30,bg="white")
          titletext_canvas.config(text=orde_titletext.get(),anchor="w")
          canvas.create_window(658, 80,window=titletext_canvas) 
          ...
          pageheadertext_canvas = Label(canvas, font=('Helvetica 10 '),width=30,bg="white")
          pageheadertext_canvas.config(text=orde_pageheadertext.get(),anchor="w")
          canvas.create_window(648, 456,window=pageheadertext_canvas) 
          ...
          if not taxcheck:
            ...
            canvas_extra = Label(canvas, font=('Helvetica 10 '),width=13)
            canvas_extra.config(text=str(orde_extracost.get()),anchor="e",bg="white")
            canvas.create_window(920, 778,window=canvas_extra)
            
            canvas_extracostname = Label(canvas, font=('Helvetica 10 '),width=16,bg="white")
            canvas_extracostname.config(text=str(orde_extracostname.get()),anchor="center")
            canvas.create_window(788, 778,window=canvas_extracostname)
            ...
            if symbolcheck[0] == "before amount":
              ...
              canvas_extra = Label(canvas, font=('Helvetica 10 '),width=13)
              canvas_extra.config(text=symbolcheck[1]+str(orde_extracost.get()),anchor="e",bg="white")
              canvas.create_window(920, 778,window=canvas_extra)
              ...
              canvas_extra = Label(canvas, font=('Helvetica 10 '),width=13)
              canvas_extra.config(text=str(orde_extracost.get())+symbolcheck[1],anchor="e",bg="white")
              canvas.create_window(920, 778,window=canvas_extra)
            ...
            if symbolcheck[0] == "before amount":
              ...
              canvas_extacost = Label(canvas, font=('Helvetica 10 '),width=13)
              canvas_extacost.config(text=symbolcheck[1]+str(orde_extracost.get()),anchor="e",bg="white")
              canvas.create_window(920, 803,window=canvas_extacost)
              ...
              canvas_extacost = Label(canvas, font=('Helvetica 10 '),width=13)
              canvas_extacost.config(text=str(orde_extracost.get())+symbolcheck[1],anchor="e",bg="white")
              canvas.create_window(920, 803,window=canvas_extacost)
          ...
          footertext_canvas = Label(canvas, font=('Helvetica 10 '),width=30,bg="white")
          footertext_canvas.config(text=orde_footertext.get(),anchor="w")
          canvas.create_window(387, 1190,window=footertext_canvas) 
        ...
        #----------------Professional 2 (logo on right side)------------------
          ...
          canvas.create_text(741, 310, text="Terms", fill="black", font=('Helvetica 11'))
          canvas.create_text(755, 330, text="Order ref.#", fill="black", font=('Helvetica 11'))
          canvas.create_text(920, 250, text=orde_orderid.get(), fill="black", font=('Helvetica 11'))
          canvas.create_text(920, 270, text=orde_date.get_date(), fill="black", font=('Helvetica 11'))
          canvas.create_text(920, 290, text=orde_duedate.get_date(), fill="black", font=('Helvetica 11'))
          canvas.create_text(920, 310, text=orde_terms.get(), fill="black", font=('Helvetica 11'))  
          ...
          canvas.create_text(650, 360, text="Ship to", fill="black", font=('Helvetica 10 underline'))
          ord_canvas_ship = Label(canvas, font=('Helvetica 10 '),width=30,bg="white")
          ord_canvas_ship.config(text=orde_ship.get(),anchor="w")
          canvas.create_window(750, 378,window=ord_canvas_ship)
          addrship_can_lab = Text(canvas,font=('Helvetica 10'),width=30,height=4,fg= "black",
          bg="white",cursor="arrow",bd=0)
          addrship_can_lab.insert("1.0",orde_shipaddr.get("1.0",END))
          addr_can_lab.config(state=DISABLED) 
          canvas.create_window(737, 420,window=addrship_can_lab)
        ...
        #----------------Business Classic------------------ 
          ...
          canvas_ordid = Label(canvas, font=('Helvetica 10 '),width=15,bg="white")
          canvas_ordid.config(text=orde_orderid.get(),anchor="w")
          canvas.create_window(962, 330,window=canvas_ordid)
          # canvas.create_text(930, 240, text="ORD1/2022", fill="black", font=('Helvetica 11'))
          canvas.create_text(930, 360, text=orde_date.get(), fill="black", font=('Helvetica 11'))
          canvas.create_text(930, 390, text=orde_duedate.get(), fill="black", font=('Helvetica 11'))
      ...
      prin= Button(firFrame,compound="top", text="Print \nOrder",relief=RAISED, image=photo5,bg="#f5f3f2", fg="black", height=55, bd=1, width=55,command=order_edit_printsele)
      prin.pack(side="left", pady=3, ipadx=4)
      ...
      labelframe1.place(x=10,y=5,width=640,height=160)
      order = Label(labelframe1, text="Order to").place(x=10,y=5)
      orde_name = ttk.Combobox(labelframe1,width=28)
      orde_name.place(x=80,y=5)
      orde_name["values"] = cusnadata
      orde_name.bind("<<ComboboxSelected>>",selecombobox)
      orde_name.insert(0, edit_ord[3])
      address=Label(labelframe1,text="Address").place(x=10,y=30)
      orde_addr=Text(labelframe1,width=23)
      orde_addr.place(x=80,y=30,height=70)
      orde_addr.insert("1.0", edit_ord[16])
      ship=Label(labelframe1,text="Ship to").place(x=342,y=5)
      orde_ship=Entry(labelframe1,width=30)
      orde_ship.place(x=402,y=3)
      orde_ship.insert(0, edit_ord[17])
      address1=Label(labelframe1,text="Address").place(x=340,y=30)
      orde_shipaddr=Text(labelframe1,width=23)
      orde_shipaddr.place(x=402,y=30,height=70)
      orde_shipaddr.insert("1.0", edit_ord[18])
      ...
      labelframe2.place(x=10,y=130,width=640,height=42)
      email=Label(labelframe2,text="Email").place(x=10,y=5)
      orde_email=Entry(labelframe2,width=30)
      orde_email.place(x=80,y=5)
      orde_email.insert(0, edit_ord[19])
      sms=Label(labelframe2,text="SMS Number").place(x=328,y=5)
      orde_sms=Entry(labelframe2,width=30)
      orde_sms.place(x=402,y=5)
      orde_sms.insert(0, edit_ord[20])

        
      labelframe = LabelFrame(fir1Frame,text="Order",font=("arial",15))
      labelframe.place(x=652,y=5,width=290,height=170)
      order=Label(labelframe,text="Order#").place(x=5,y=5)
      orde_orderid=Entry(labelframe,width=25)
      ...
      orde_terms.insert(0, edit_ord[32])
      ref=Label(labelframe,text="Order ref#").place(x=5,y=118)
      orde_order_ref=Entry(labelframe,width=27)
      orde_order_ref.place(x=100,y=118)
      ...
      sql = "select * from company"
      fbcursor.execute(sql)
      edit_maintree = fbcursor.fetchone()
      
      if not edit_maintree:
        edit_pro_tree=ttk.Treeview(listFrame)
        edit_pro_tree["columns"]=["1","2","3","4","5","6","7"]
        ...
        edit_pro_tree.column("7", width=80)
        ...
        edit_pro_tree.heading("7",text="Price")
        edit_pro_tree.pack(fill="both", expand=1)
      elif edit_maintree[12] == '1':
        edit_pro_tree=ttk.Treeview(listFrame)
        edit_pro_tree["columns"]=["1","2","3","4","5","6","7"]
        ...
        edit_pro_tree.pack(fill="both", expand=1)
      elif edit_maintree[12] == '3':
        edit_pro_tree=ttk.Treeview(listFrame)
        edit_pro_tree["columns"]=["1","2","3","4","5","6","7","8","9"]
        ...
        edit_pro_tree.column("6", width=60)
        edit_pro_tree.column("7", width=60)
        edit_pro_tree.column("8", width=60)
        edit_pro_tree.column("9", width=80)
        ...
        edit_pro_tree.heading("6",text="Pcs/Weight")
        edit_pro_tree.heading("7",text="Tax1")
        edit_pro_tree.heading("8",text="Tax2")
        edit_pro_tree.heading("9",text="Price")
        edit_pro_tree.pack(fill="both", expand=1)
      ...
      template=Label(labelframe1,text="Template").place(x=37,y=70)
      orde_templ=ttk.Combobox(labelframe1,width=25)
      orde_templ["values"] = ["Professional 1 (logo on left side)","Professional 2 (logo on right side)","Simplified 1 (logo on left side)","Simplified 2 (logo on right side)","Business Classic"]
      orde_templ.place(x=115,y=70)
      orde_templ.insert(0, edit_ord[11])
      sales=Label(labelframe1,text="Sales Person").place(x=25,y=100)
      orde_sales=Entry(labelframe1,width=18)
      orde_sales.place(x=115,y=100)
      orde_sales.insert(0, edit_ord[12])
      category=Label(labelframe1,text="Category").place(x=300,y=100)
      orde_cat=Entry(labelframe1,width=22)
      orde_cat.place(x=370,y=100)
      orde_cat.insert(0, edit_ord[12])
      ...
      text1=Label(headerFrame,text="Title text").place(x=50,y=5)
      orde_titletext=ttk.Combobox(headerFrame, value="",width=60)
      orde_titletext.place(x=125,y=5)
      orde_titletext.insert(0, edit_ord[33])
      text2=Label(headerFrame,text="Page header text").place(x=2,y=45)
      orde_pageheadertext=ttk.Combobox(headerFrame, value="",width=60)
      orde_pageheadertext.place(x=125,y=45)
      orde_pageheadertext.insert(0, edit_ord[34])
      text3=Label(headerFrame,text="Footer text").place(x=35,y=85)
      orde_footertext=ttk.Combobox(headerFrame, value="",width=60)
      orde_footertext.place(x=125,y=85)
      orde_footertext.insert(0, edit_ord[35])

      text=Label(noteFrame,text="Private notes(not shown on invoice/order/estemates)").place(x=10,y=10)
      orde_privatenotes=Text(noteFrame,width=100,height=7)
      orde_privatenotes.place(x=10,y=32)
      orde_privatenotes.insert('1.0', edit_ord[27])

      orde_termsnotes=Text(termsFrame,width=100,height=9)
      orde_termsnotes.place(x=10,y=10)
      orde_termsnotes.insert('1.0', edit_ord[36])

      orde_commands=Text(commentFrame,width=100,height=9)
      ...
      val = (ord_editid,)
      fbcursor.execute(sql,val)
      docum = fbcursor.fetchall()
      countd = 0
      for i in docum:
        file_size = doc_check_convertion(os.path.getsize('images/'+i[6]))
        ord_edit_doc_tree.insert(parent='', index='end',text='', values=('',i[6],file_size))
        countd += 1
      ...
      val = (ord_editid,)
      fbcursor.execute(sql,val)
      dispro = fbcursor.fetchall()
      sql = "select * from company"
      fbcursor.execute(sql)
      display_editprotree = fbcursor.fetchone()
      for i in dispro:
        if not display_editprotree:
          edit_pro_tree.insert(parent='', index='end',text='', values=(i[5],i[6],i[7],i[8],i[9],i[10],i[13]))
          coutp += 1
        elif display_editprotree[12] == "1":
          edit_pro_tree.insert(parent='', index='end',text='', values=(i[5],i[6],i[7],i[8],i[9],i[10],i[13]))
          extracs = 0.0
          discou = 0.0
          total = 0.0
      ...
      if orddetails[11] == 'Professional 1 (logo on left side)':
        ...
        if not taxcheck:
          ...
          if symbolcheck[0] == "before amount":
            ...
            canvas.create_text(780, 730, text=(orddetails[13])+"%Discount", fill="black", font=('Helvetica 10'))
            canvas_disc = Label(canvas, font=('Helvetica 10 '),width=13)
  ...
  def order_search():  
      def ord_searchfun():
        if findIN.get() == "Oder#":
          ...
          for i in ord_id:
            ...
            counto += 1
        elif findIN.get() == "Customer name":
          sql = 'select * from orders where businessname = %s'
          val = (n.get(),)
          fbcursor.execute(sql,val)
          cusname = fbcursor.fetchall()
          counto = 0
          for record in ordtree.get_children():
            ordtree.delete(record)
          for i in cusname:
      ...
      findwhat1=Label(top,text="Find What:",pady=5,padx=10).place(x=5,y=60)
      n = StringVar()
      findwhat = Entry(top, width = 40, textvariable = n )
      findwhat.place(x=90,y=65)
    
      findin1=Label(top,text="Find in:",pady=5,padx=10).place(x=5,y=100)
      ne = StringVar()
      findIN = ttk.Combobox(top, width = 30, textvariable = ne)
      findIN['values'] = ('Oder#', 'Customer name')
      findIN.current(0)                       
      findIN.place(x=90,y=105)
      

      findButton = Button(top, text ="Serach",width=10,command=ord_searchfun).place(x=480,y=33)
      closeButton = Button(top,text ="Close",width=10,command=top.destroy).place(x=480,y=62)
  ...
  purchaseLabel = Button(order_midFrame,compound="top", text="Print\nSelected",relief=RAISED, image=photo5,bg="#f8f8f2", fg="black", height=55, bd=1, width=55,command=order_printsele)#temperay
  ...
  class MyApp:
    def __init__(self, parent):
      ...
      ordtree.bind('<ButtonRelease-1>',ord_view_details)
